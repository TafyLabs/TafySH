"""Health checks for TafySH components.
...
class HealthChecker:
    """Performs health checks on TafySH components.
    ...
    def _check_shell(self) -> HealthResult:
        ...
        try:
            from tafysh.shell.manager import get_shell_manager
    ...
    def _check_llm(self) -> HealthResult:
        ...
        try:
            from tafysh.llm.client import get_llm_client
    ...
    def _check_memory(self) -> HealthResult:
        ...
        try:
            from tafysh.memory.manager import get_memory_manager
