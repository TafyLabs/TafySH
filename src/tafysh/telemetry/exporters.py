"""Telemetry exporters for TafySH.
...
from tafysh.telemetry.events import EventType, TelemetryEvent, get_event_emitter
from tafysh.telemetry.logger import get_logger
from tafysh.telemetry.metrics import MetricsRegistry, get_metrics_registry
...
class FileExporter(Exporter):
    ...
    Example:
        exporter = FileExporter(Path("~/.tafysh/telemetry.log"))
...
def setup_default_exporters(
    ...
    """Set up default exporters for TafySH.
    ...
    if not exporters:
        # Default to file exporter in ~/.tafysh
        default_path = Path("~/.tafysh/telemetry.log").expanduser()
