...
class CompletionMode(str, Enum):
    ...
    NATIVE = "native"  # Only TafySH completions
    PASSTHROUGH = "passthrough"  # Full PTY passthrough
    HYBRID = "hybrid"  # Merge TafySH + shell completions (default)
...
class ShellConfig(BaseModel):
    ...
    rc_file: Optional[Path] = Field(
        default=None,
        description="Custom RC file to source (~/.tafyshrc by default)",
    )
...
class TafySHConfig(BaseModel):
    """Root configuration for TafySH."""
