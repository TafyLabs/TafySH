...
from tafysh.utils.ux import Color, OutputBuffer, colorize
...
class HelpSystem:
    ...
    def format_overview(self, use_color: bool = True) -> str:
        ...
        buf.add_header("TafySH Help", level=1)
        buf.add_line("")
    ...
    def _register_builtin_topics(self) -> None:
        ...
        self.register(
            HelpTopic(
                name="intro",
                title="Introduction to TafySH",
                category=HelpCategory.GETTING_STARTED,
                summary="Overview of TafySH and its capabilities",
                aliases=["introduction", "overview", "about"],
                content="""
TafySH is an AI-enhanced terminal shell that combines traditional shell
...
""",
        ...
        self.register(
            HelpTopic(
                ...
                category=HelpCategory.GETTING_STARTED,
                summary="Get started with TafySH in 5 minutes",
...
4. SPECIAL COMMANDS
   Use colon commands for TafySH features:
   :help     - Show help
...
Exit:
  :quit            Exit TafySH
  :exit            Exit TafySH (alias)
  :q               Exit TafySH (short alias)
...
Notes:
  - History is stored in ~/.tafysh/history
...
TafySH wraps your default shell and adds AI capabilities.
...
Classification:
  TafySH automatically classifies input as either:
...
TafySH implements multiple security layers:
...
Environment Variables:
  TAFYSH_CONFIG     - Config file path
...
History Not Saving:
  1. Check ~/.tafysh/ directory exists
