"""Shell Wrapper - Main REPL interface for TafySH."""
...
from tafysh.shell.history import HistoryManager, ReadlineHistory
...
from tafysh.shell.prompt import AgentStatus, PromptRenderer, PromptStyle
from tafysh.shell.pty_manager import PTYManager
from tafysh.telemetry.logger import get_logger, LoggerMixin
...
class ShellWrapper(LoggerMixin):
    ...
    def __init__(self, config: "TafySHConfig") -> None:
    ...
    def run(self) -> None:
        ...
        """
        self._running = True
        self.logger.info("Starting TafySH shell")
    ...
    def _handle_special_command(self, classified: ClassifiedInput) -> None:
        """Handle special TafySH commands.
    ...
    def _print_welcome(self) -> None:
        ...
        print("=" * 60)
        print("  TafySH - AI-Enhanced Terminal Shell")
        print("=" * 60)
        print()
        print("  Commands:")
