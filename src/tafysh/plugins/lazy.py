...
class LazyPlugin:
    ...
    Attributes:
        name: Plugin name
        module_path: Full module path (e.g., "tafysh.plugins.builtin.shell")
...
BUILTIN_PLUGINS: list[tuple[str, str, str]] = [
    ("shell", "tafysh.plugins.builtin.shell", "ShellToolset"),
    ("filesystem", "tafysh.plugins.builtin.filesystem", "FilesystemToolset"),
    ("process", "tafysh.plugins.builtin.process", "ProcessToolset"),
    ("code", "tafysh.plugins.builtin.code", "CodeToolset"),
    ("remote", "tafysh.plugins.builtin.remote", "RemoteToolset"),
]
...
OPTIONAL_PLUGINS: list[tuple[str, str, str, list[str]]] = [
    ...
    # Example: ("ros", "tafysh.plugins.robotics.robotics_toolset", "RoboticsToolset", ["rclpy"])
]
