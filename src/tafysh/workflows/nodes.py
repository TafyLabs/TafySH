...
from tafysh.agent.llm_client import LLMClient, Message, ToolCall, ToolDefinition
from tafysh.agent.prompts import build_system_prompt
from tafysh.security.approval import ApprovalFlow, ApprovalResult
...
from tafysh.security.rbac import Role, User
from tafysh.telemetry.logger import get_logger
from tafysh.tools.base import Tool, ToolResult
...
class ApprovalNode:
    ...
    async def _request_approval(
        ...
        from tafysh.security.approval import ApprovalRequest as ApprovalReq
